...
The security goal of a psuedorandom function (PRF) that it guarantees that all of its outputs appear random and are indistinguishable, regardless of how the corresponding inputs were chosen.
